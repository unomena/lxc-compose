#!/bin/bash
# Port forwarding tests for Django Minimal application
...
echo "=== Port Forwarding Tests for Django Minimal ==="
echo
...
# Define expected port mappings (single container with both services)
